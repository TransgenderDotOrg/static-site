...
export const FAQsPage = () => {
  ...
  const [faqs, setResources] = React.useState<FAQ[]>([])
  ...
  React.useEffect(() => {
    const fetchResources = async () => {
      ...
      const resourcesArray: FAQ[] = Object.values(resources)
  ...
  const {
    ...
    prevPage,
    setPage,
  } = usePagination<FAQ>(filteredResources, 20, pageString ? parseInt(pageString, 10) : 1)
  ...
  return (
    <Box sx={{ padding: '2rem' }}>
      <Typography variant='h3'>{i18n.t('header.menuitem.faqs')}</Typography>
