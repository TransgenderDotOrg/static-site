...
{{
  id: string [required]
  title: string [required] (A short title for the resource, in english)
  description: string [required] (A short description about what the resource is about and how it serves the transgender community, in english)
  slug: string [required] [unique] (en-US, kebab-case)
  externalUrl: Url (string)
  tags: Tags{{ transmasculine, non-binary, transfeminine, legal, healthcare, mental-health, social-services, youth-services, support-groups, parent-family-resources, partner-resources, community-stories, education-awareness, financial-aid-scholarships, clothing, artists-creators, friendly-businesses, makeup, voice-training, discord-groups, spiritual }}[] (attribute all that are relevant)
  organizationType: OrganizationType{{ national-organization, local-office, community-center, online-platform, healthcare-provider, informed-consent-clinic, support-group, legal-service, educational-institution, non-profit-organization, government-entity, private-practice }}[] (attribute all that are relevant)
